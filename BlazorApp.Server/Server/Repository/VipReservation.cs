...
namespace BlazorApp.Server.Repository
{
    public class VipReservation : IReservation
    {
        ...
        public VipReservation(ApplicationDbContext context, INotification notification)
        {
            _context = context;
        ...
        public ReservationResponse CreateReservation(Reservation reservation, Guid userId)
        {
            ...
            try
            {
                ...
                if (user != null)
                {
                    var message = $"Dear vip {reservation.CustomerName}, your reservation for {reservation.NumberOfPeople} people on {reservation.ReservationDate} has been created successfully.";
    ...
    public class RegularUserReservation : IReservation
    {
        private readonly ApplicationDbContext _context;
        private readonly INotification _notification;

        public RegularUserReservation(ApplicationDbContext context, INotification notification)
        {
            _context = context;
            _notification = notification;
        }
